...
set CLASSPATH=%APP_HOME%\lib\SampleAPI-all.jar

@rem Execute SampleAPI
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SAMPLE_API_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%SAMPLE_API_EXIT_CONSOLE%" exit 1
exit /b 1
